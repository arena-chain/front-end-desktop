    ...
    container.innerHTML = state.friends.map(f => `
        <div class="glass-panel rounded-2xl p-5 flex items-center gap-4 hover:border-[#00ff87]/20 transition-all cursor-pointer" data-profile-id="${f.userId}">
            ...
            <div class="flex gap-2">
                <button onclick="window.openChat('${f.userId}')" class="px-3 py-1.5 text-[10px] font-bold rounded-lg bg-[#22d3ee]/20 text-[#22d3ee] border border-[#22d3ee]/30 hover:bg-[#22d3ee]/30 transition-all">MESSAGE</button>
        ...
        if (friendIds.has(u._id)) {
            ...
            actionHtml = `
                <div class="flex items-center gap-2">
                    <button onclick="window.openChat('${u._id}')" class="px-3 py-1.5 text-[10px] font-bold rounded-lg bg-[#22d3ee]/20 text-[#22d3ee] border border-[#22d3ee]/30 hover:bg-[#22d3ee]/30 transition-all">MESSAGE</button>
                    <button data-action="add" data-id="${u._id}" class="search-action-btn px-4 py-1.5 text-[10px] font-bold rounded-lg bg-[#00ff87]/20 text-[#00ff87] border border-[#00ff87]/30 hover:bg-[#00ff87]/30 transition-all">ADD FRIEND</button>
                </div>
            `;
        }
        return `
