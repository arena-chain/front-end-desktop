...
"@
    ...
    // Kept for LoL lobby status updates
    function updateSteamStatus(text, type = 'info') {
        ...
        if (type === 'error') {
            ...
            if (icon) icon.className = 'w-12 h-12 bg-red-500/10 rounded-xl mx-auto mb-4 flex items-center justify-center border border-red-500/20';
        } else if (type === 'success') {
            el.className = 'text-sm font-bold text-[#00ff87] mb-4';
            if (icon) icon.className = 'w-12 h-12 bg-[#00ff87]/10 rounded-xl mx-auto mb-4 flex items-center justify-center border border-[#00ff87]/20';
        } else {
            el.className = 'text-sm font-bold text-[#66C0F4] mb-4 italic';
            if (icon) icon.className = 'w-12 h-12 bg-[#1b2838] rounded-xl mx-auto mb-4 flex items-center justify-center border border-[#66c0f4]/20';
        }
    }
