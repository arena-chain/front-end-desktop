    ...
    connectedCallback() {
        ...
        if (file) {
            try {
                ...
                if (file === 'top_navbar.html') {
                    try {
                        require(path.join(commonDir, 'notification.js'));
                        require(path.join(commonDir, 'notificationInit.js'));
                    } catch (e) {
                        console.error('notification boot failed', e);
                    }
                }
            } catch (err) {
